                    ...
                    <div class="card custom-card">
                        ...
                        <form action="{{ route('deposit-amount') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group d-flex justify-content-center" style="text-align:center">
                                    @if (isset($data->image) && $data->image != null)
                                        <img src="{{ asset('images/' . $data->image) }}" style="width:150px;" />
                                    @else
                                        <strong>QR Code Not Found</strong>
                                    @endif
                                </div>
                                <br />
                                <div style="text-align:center" class="fw-bold d-flex justify-content-center">
                                    <hr width="100%" style="margin: 11px">OR
                                    <hr width="100%" style="margin: 11px">
                                </div>
                                <label for="exampleInputEmail1" style="text-align:center !important">Wallet ID</label>
                                <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                                    <!-- <input type="text" class="form-control datetimepicker-input" data-target="#reservationdatetime"> -->
                                    <input type="text" name="walletid" value="{{ $data->walletid ?? '' }}"
...
@push('js')
    ...
    <script src="{{ asset('userpanel/assets/libs/filepond-plugin-image-edit/filepond-plugin-image-edit.min.js') }}">
    </script>
    <script
    ...
    <script src="{{ asset('userpanel/assets/libs/filepond-plugin-image-crop/filepond-plugin-image-crop.min.js') }}">
    </script>
    <script src="{{ asset('userpanel/assets/libs/filepond-plugin-image-resize/filepond-plugin-image-resize.min.js') }}">
    </script>
    <script
        src="{{ asset('userpanel/assets/libs/filepond-plugin-image-transform/filepond-plugin-image-transform.min.js') }}">
    </script>
